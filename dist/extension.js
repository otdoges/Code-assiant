...
function activate(context) {
    ...
    const sidebarView = vscode.window.registerWebviewViewProvider('code-explorer.sidebar', sidebarProvider);
    context.subscriptions.push(sidebarView);
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('code-explorer.showSidebar', async () => {
...
class ConfigurationService {
    constructor(context) {
        this.API_KEY_SECRET = 'github-ai-assistant.apiKey';
